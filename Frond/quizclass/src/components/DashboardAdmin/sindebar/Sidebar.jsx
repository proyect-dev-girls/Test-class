...
const Sidebar = () => {
  ...
  //Filtrar notificaciones que son para el profesor
  const professorNotifications = notifications.filter(notif => notif.recipient === 'professor');
  ...
  return (
    <div className="h-screen w-64 bg-white text-gray-800 shadow-lg border border-[#a4cc64]">
      ...
      <nav className="mt-10 p-2">
        ...
        <img src={imageNene} alt="Nene" className="w-40 h-40 rounded-full shadow-lg" />
        ...
        <div className="relative ml-4 bg-gradient-to-r from-[#f48ca4] to-[#a4cc64] p-4 rounded-xl shadow-lg border border-gray-300 text-center text-white">
          <p className="text-lg font-semibold ">Bienvenido, profesor/a. Es un placer tenerte aquí.😊</p>
        </div>
      </div>
    </div>
  );
