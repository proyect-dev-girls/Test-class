    ...
    <div className="flex h-screen bg-gray-100">
      ...
      >
        ...
        <div className="flex flex-col space-y-2">
          ...
          <Link
            to={"/"}
            className="flex items-center p-2 rounded-lg hover:bg-[#f48ca4] transition duration-300"
          >
            <span className="text-xl mr-2">🔒</span>
            <span>Salir</span>
          </Link>
      ...
      <div className="flex-1 p-8 bg-gradient-to-r from-[#f48ca4] to-[#a4cc64]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {quizzes.map((quiz, index) => (
            ...
            >
              <h2 className="text-xl font-bold mb-2 text-[#a4cc64]">
                Pregunta {index + 1}
              </h2>
              {quiz.image && (
                <img
        ...
        {selectedQuiz && (
          <div className="mt-8 p-6 bg-white rounded-lg shadow-lg border border-[#a4cc64]">
            <h2 className="text-2xl font-bold mb-4 text-[#a4cc64]">
              Quiz Seleccionado
            </h2>
            {selectedQuiz.image && (
              <img
